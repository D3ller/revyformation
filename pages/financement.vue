...
useHead({
  title: "Financement – RevyFormation",
})
</script>

<template>
  <div class="page_financement">
    <section class="container max-lg:mt-14 mb-110 flex flex-col items-center justify-center">
      <h1 class="mb-10">Financement</h1>
